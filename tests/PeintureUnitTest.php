...
class PeintureUnitTest extends TestCase
{
    public function testIsTrue()
    {
        ...
        $this->assertTrue($peinture->getcreatDate()=== $datetime);
    ...
    public function testIsFalse()
    {
        ...
        $this->assertFalse($peinture->getcreatDate()=== new DateTime());
    ...
    public function testIsEmpty()
    {
        ...
        $this->assertEmpty($peinture->getcreatDate());
